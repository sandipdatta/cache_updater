...
def update_context_cache(cloud_event):
    ...
    history_doc_ref = firestore_client.collection('context_caches_history').document(timestamp_id)
    ...
    if old_cache_id:
        try:
            ...
            print(f"Warning: Failed to delete old cache {old_cache_id}. It may need manual cleanup. Error: {e}")